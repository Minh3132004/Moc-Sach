...
public class OrderResponse {
    ...
    private String couponCode; // Mã giảm giá áp dụng cho đơn hàng (tùy chọn)
    private Integer couponDiscountPercent; // % giảm giá từ mã coupon (nếu có)
    private String paymentStatus; // Trạng thái thanh toán: PENDING (chưa thanh toán), PAID (đã thanh toán)
    private List<OrderDetailResponse> listOrderDetails; // Danh sách chi tiết đơn hàng
